...
namespace NMUG.Controllers
{
    public class SponsorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,GoldSponsors,PatronSponsors,PlatinumSponsors,SilverSponsors")] Sponsor sponsor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,GoldSponsors,PatronSponsors,PlatinumSponsors,SilverSponsors")] Sponsor sponsor)
        {
            if (id != sponsor.ID)
            {
                return NotFound();
